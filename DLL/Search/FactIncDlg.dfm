object fmFactIncDlg: TfmFactIncDlg
  Left = 441
  Top = 0
  BorderWidth = 1
  Caption = #1059#1089#1083#1086#1074#1080#1103' '#1087#1086#1080#1089#1082#1072' '#1074#1072#1075#1086#1085#1086#1074
  ClientHeight = 599
  ClientWidth = 440
  Color = clBtnFace
  ...
  object Panel8: TPanel
    ...
    object cxCheckBox2: TcxCheckBox
      Left = 7
      Top = 12
      Caption = #1054#1090#1095#1105#1090'. '#1087#1077#1088#1080#1086#1076
    ...
    object cxRadioGroup1: TcxRadioGroup
      ...
      Properties.Items = <
        item
          Caption = #1055#1088#1077#1081#1089#1082'.10-01 ('#1091#1095#1080#1090'. '#1074' RUB)'
        end
        item
          Caption = #1058#1055' '#1057#1053#1043' '#1074' '#1088#1091#1073#1083#1103#1093' ('#1091#1095#1080#1090'. '#1074' RUB)'
        end
        item
          Caption = #1058#1055' '#1057#1053#1043' ('#1091#1095#1080#1090'. '#1074' USD)'
        end
        item
          Caption = #1058#1055' '#1057#1053#1043' '#1074' USD ('#1091#1095#1080#1090'. '#1074' USD '#1080' RUB)'
        end>
      ItemIndex = 0
      Style.LookAndFeel.Kind = lfUltraFlat
      Style.LookAndFeel.NativeStyle = False
  ...
  object Panel13: TPanel
    ...
    object Panel7: TPanel
      ...
      object cxLabel9: TcxLabel
        Left = 8
        Top = 13
        Caption = #1055#1086#1076#1082#1086#1076' '#1101#1082#1089#1087#1077#1076#1080#1090'...............'
      end
      object cxLabel5: TcxLabel
        Left = 7
        Top = 36
        Caption = #8470' '#1091#1095'. '#1079#1072#1087#1080#1089#1080'.............'
        ParentFont = False
    ...
    object Panel6: TPanel
      ...
      object cxLookupComboBox3: TcxLookupComboBox
        ...
        Properties.ListSource = DS_BeginNode
      ...
      object cxLookupComboBox5: TcxLookupComboBox
        ...
        Properties.ListOptions.ShowHeader = False
        Properties.ListSource = DS_EndNode
      ...
      object cxLookupComboBox2: TcxLookupComboBox
        ...
        Properties.ListOptions.ShowHeader = False
        Properties.ListSource = DS_KargoETSNG
      ...
      object cxLookupComboBox8: TcxLookupComboBox
        ...
        Properties.DropDownListStyle = lsFixedList
        Properties.DropDownRows = 15
        Properties.KeyFieldNames = 'file_name_dbf'
        Properties.ListColumns = <
          item
            FieldName = 'file_name_dbf'
          end>
        Properties.ListOptions.ShowHeader = False
        Properties.ListSource = DS_FilesName
        Style.Color = clWindow
        Style.LookAndFeel.Kind = lfUltraFlat
        Style.LookAndFeel.NativeStyle = False
        Style.LookAndFeel.ScrollbarMode = sbmClassic
    ...
    object GridPanel1: TGridPanel
      ...
      ColumnCollection = <
        item
          Value = 37.506845442772630000
        end
        item
          Value = 31.246605573129310000
        end
        item
          Value = 31.246548984098050000
        end>
      ControlCollection = <
        item
          Column = 0
      ...
      object Panel4: TPanel
        ...
        object cxRadioGroup4: TcxRadioGroup
          ...
          Properties.Items = <
            item
              Caption = #1042#1077#1089#1100' '#1092#1072#1082#1090
            end
            item
              Caption = #1056#1072#1079#1085#1077#1089#1077#1085#1085#1099#1081
            end
            item
              Caption = #1053#1045' '#1088#1072#1079#1085#1077#1089#1105#1085#1085#1099#1081
            end
            item
      ...
      object Panel9: TPanel
        ...
        object cxRadioGroup5: TcxRadioGroup
          ...
          Properties.Items = <
            item
              Caption = #1042#1089#1103' '#1074#1072#1083#1102#1090#1072
            end
            item
              Caption = #1056#1059#1041
            end
            item
              Caption = #1053#1045' '#1056#1059#1041
            end>
          ItemIndex = 0
          Style.LookAndFeel.Kind = lfUltraFlat
          Style.LookAndFeel.NativeStyle = False
    ...
    object Panel2: TPanel
      ...
      object Panel17: TPanel
        ...
        object cxCheckBox5: TcxCheckBox
          Left = 209
          Top = 25
          Caption = #1055#1088#1080#1073#1099#1090#1080#1077' '#1073#1099#1083#1086
          Style.LookAndFeel.Kind = lfUltraFlat
          Style.LookAndFeel.NativeStyle = False
          Style.LookAndFeel.ScrollbarMode = sbmClassic
          Style.LookAndFeel.SkinName = 'Coffee'
        ...
        object cxCheckBox4: TcxCheckBox
          Left = 0
          Top = 2
          Caption = #1055#1077#1088#1080#1086#1076' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1080#1103
      ...
      object cxCheckBox3: TcxCheckBox
        Left = 4
        Top = 4
        Caption = #1052#1077#1089#1103#1094' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1080#1103
        Style.LookAndFeel.Kind = lfUltraFlat
        Style.LookAndFeel.NativeStyle = False
        Style.LookAndFeel.ScrollbarMode = sbmClassic
        Style.LookAndFeel.SkinName = 'Coffee'
  ...
  object Query_BeginNode: TADOQuery
    CursorType = ctStatic
    Filtered = True
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM fact_inc_temp_sto '
      'ORDER BY sto_name')
    Left = 60
    Top = 243
  end
  object DS_BeginNode: TDataSource
    DataSet = Query_BeginNode
    Left = 78
    Top = 246
  end
  object Query_EndNode: TADOQuery
    CursorType = ctStatic
    Filtered = True
    Parameters = <>
    SQL.Strings = (
      'SELECT stn_name, stn FROM fact_inc_temp_stn'
      'ORDER BY stn_name')
    Left = 135
    Top = 336
  end
  object DS_EndNode: TDataSource
    DataSet = Query_EndNode
    Left = 153
    Top = 345
  end
  object Query_KargoETSNG: TADOQuery
    CursorType = ctStatic
    Filtered = True
    Parameters = <>
    SQL.Strings = (
      'SELECT  gruz_name, gruz FROM fact_inc_temp_gruz '
      'ORDER BY gruz_name')
    Left = 42
    Top = 371
  end
  object DS_KargoETSNG: TDataSource
    DataSet = Query_KargoETSNG
    Left = 63
    Top = 383
  end
  ...
  object DS_FilesName: TDataSource
    DataSet = Query_FilesName
    Left = 207
    Top = 407
  end
  object Query_FilesName: TADOQuery
    CursorType = ctStatic
    Filtered = True
    Parameters = <>
    SQL.Strings = (
      'SELECT DISTINCT file_name_dbf '
      'FROM'#9'view_fact_inc_temp '
      'WHERE 1=0'
      'ORDER BY file_name_dbf')
    Left = 186
    Top = 395
  end
end
