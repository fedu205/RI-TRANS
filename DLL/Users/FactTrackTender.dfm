object fmFactTrackTender: TfmFactTrackTender
  Left = 0
  Top = 0
  Caption = #1055#1088#1072#1074#1080#1083#1072' '#1090#1086#1088#1075#1086#1074' '#1087#1086' '#1087#1088#1086#1089#1090#1086#1103#1084' '#1074#1072#1075#1086#1085#1086#1074
  ClientHeight = 440
  ClientWidth = 859
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skCount
          Column = cxGrid1DBBandedTableView1tender_cod
        end>
      ...
      object cxGrid1DBBandedTableView1tender_id: TcxGridDBBandedColumn
        Caption = #8470' '#1079#1072#1087#1080#1089#1080
        DataBinding.FieldName = 'tender_id'
      ...
      object cxGrid1DBBandedTableView1tender_cod: TcxGridDBBandedColumn
        Caption = #8470' '#1087#1088#1086#1090#1086#1082#1086#1083#1072
        DataBinding.FieldName = 'tender_cod'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 80
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1tender_date: TcxGridDBBandedColumn
        Caption = #1044#1072#1090#1072' '#1087#1088#1086#1090#1086#1082#1086#1083#1072
        DataBinding.FieldName = 'tender_date'
        DataBinding.IsNullValueType = True
      ...
      object cxGrid1DBBandedTableView1tender_date_public: TcxGridDBBandedColumn
        Caption = #1044#1072#1090#1072' '#1087#1091#1073#1083#1080#1082#1072#1094#1080#1080
        DataBinding.FieldName = 'tender_date_public'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxDateEditProperties'
        HeaderAlignmentVert = vaTop
        Width = 80
      ...
      object cxGrid1DBBandedTableView1tender_date_registr: TcxGridDBBandedColumn
        Caption = #1056#1077#1075#1080#1089#1090#1088#1072#1094#1080#1103' '#1073#1072#1085#1082#1086#1084
        DataBinding.FieldName = 'tender_date_registr'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 80
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1tender_date_force: TcxGridDBBandedColumn
        Caption = #1042#1089#1090#1091#1087#1083#1077#1085#1080#1077' '#1074' '#1089#1080#1083#1091
        DataBinding.FieldName = 'tender_date_force'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxDateEditProperties'
        Properties.SaveTime = False
        Properties.ShowTime = False
      ...
      object cxGrid1DBBandedTableView1tender_date_begin: TcxGridDBBandedColumn
        Caption = #1044#1077#1089#1090#1074#1080#1077' '#1089'...'
        DataBinding.FieldName = 'tender_date_begin'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxDateEditProperties'
        Properties.SaveTime = False
        HeaderAlignmentVert = vaTop
      ...
      object cxGrid1DBBandedTableView1tender_date_end: TcxGridDBBandedColumn
        Caption = #1044#1077#1081#1089#1090#1074#1080#1077' '#1087#1086'.....'
        DataBinding.FieldName = 'tender_date_end'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxDateEditProperties'
        Properties.SaveTime = False
        HeaderAlignmentVert = vaTop
      ...
      object cxGrid1DBBandedTableView1tender_rate_1: TcxGridDBBandedColumn
        Caption = #1062#1080#1089#1090#1077#1088#1085#1099' '#1089' 1 '#1087#1086' 4 '#1089#1091#1090#1082#1080' '#1089#1074#1077#1088#1093#1085#1086#1088#1084', '#1087#1086#1089#1090#1072#1074#1082#1072' '#1057#1059#1043
        DataBinding.FieldName = 'tender_rate_1'
        DataBinding.IsNullValueType = True
      ...
      object cxGrid1DBBandedTableView1tender_rate_2: TcxGridDBBandedColumn
        Caption = #1062#1080#1089#1090#1077#1088#1085#1099' '#1089' 1 '#1087#1086' 4 '#1089#1091#1090#1082#1080' '#1089#1074#1077#1088#1093#1085#1086#1088#1084', '#1087#1086#1089#1090#1072#1074#1082#1072' '#1041#1080#1088#1078#1077#1074#1086#1075#1086' '#1090#1086#1074#1072#1088#1072
        DataBinding.FieldName = 'tender_rate_2'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#,##0.00'
        HeaderAlignmentVert = vaTop
      ...
      object cxGrid1DBBandedTableView1tender_rate_3: TcxGridDBBandedColumn
        Caption = 
          #1062#1080#1089#1090#1077#1088#1085#1099' '#1089#1074#1099#1096#1077' 5 '#1089#1091#1090#1086#1082' '#1089#1074#1077#1088#1093#1085#1086#1088#1084', '#1087#1086#1089#1090#1072#1074#1082#1072' '#1041#1080#1088#1078#1077#1074#1086#1075#1086' '#1090#1086#1074#1072#1088#1072' + '#1057#1059 +
          #1043
        DataBinding.FieldName = 'tender_rate_3'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#,##0.00'
        HeaderAlignmentVert = vaTop
      ...
      object cxGrid1DBBandedTableView1tender_rate_4: TcxGridDBBandedColumn
        Caption = #1055#1083#1072#1090#1092#1086#1088#1084#1072' '#1089#1074#1099#1096#1077' 1 '#1089#1091#1090#1086#1082' '#1089#1074#1077#1088#1093#1085#1086#1088#1084', '#1087#1086#1089#1090#1072#1074#1082#1072'  '#1057#1059#1043
        DataBinding.FieldName = 'tender_rate_4'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#,##0.00'
        HeaderAlignmentVert = vaTop
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\FactTrackTender'
  ...
  object Query_Tender: TADOQuery
    ...
    SQL.Strings = (
      'SELECT * FROM view_fact_track_tender')
    Left = 30
    Top = 84
  end
  object DS_Tender: TDataSource
    DataSet = Query_Tender
    Left = 29
    Top = 113
  end
  object dxBarPopup_Tender: TdxBarPopupMenu
  ...
  object ADOTender: TADOConnection
    CommandTimeout = 300
