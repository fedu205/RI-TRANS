...
begin
  ...
  Q.SQL.Add('and (select date_period from view_bargain where bargain_id = ' + IntToStr(Fbargain_id) + ') between dateadd(MM, -1, isnull(date_begin, getdate())) and DATEADD(MM, 1, isnull(date_end, getdate()))');
