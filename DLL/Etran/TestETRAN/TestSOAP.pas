...
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    RIO.HTTPWebNode.ConnectTimeout := 300000; //5 мин;
    RIO.HTTPWebNode.SendTimeout    := 300000; //5 мин;
    RIO.HTTPWebNode.ReceiveTimeout := 300000; //5 мин;
