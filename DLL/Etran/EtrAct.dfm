object fmEtrAct: TfmEtrAct
  ...
  object Panel1: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.DataSource = DS_Act
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            Column = cxGrid1DBBandedTableView1act_id
          end>
  ...
  object Panel2: TPanel
        ...
        object cxGrid2: TcxGrid
          ...
          object cxGrid2DBBandedTableView1: TcxGridDBBandedTableView
            ...
            DataController.Summary.FooterSummaryItems = <
              item
                Kind = skCount
                Column = cxGrid2DBBandedTableView1actCar_id
              end>
            DataController.Summary.SummaryGroups = <>
            DataController.Summary.Options = [soMultipleSelectedRecords]
            OptionsData.CancelOnExit = False
        ...
        object cxGrid3: TcxGrid
          ...
          object cxGridDBBandedTableView1: TcxGridDBBandedTableView
            ...
            DataController.Summary.FooterSummaryItems = <
              item
                Kind = skCount
                Column = cxGridDBBandedTableView1actEmp_id
              end>
            DataController.Summary.SummaryGroups = <>
            DataController.Summary.Options = [soMultipleSelectedRecords]
            OptionsData.CancelOnExit = False
    ...
    object Panel4: TPanel
      ...
      object Label1: TLabel
        ...
        Width = 182
        Height = 13
        Caption = #1048#1044' '#1072#1082#1090#1072'...................................'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\EtrAct'
  ...
  object Query_Act: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9#9'etran_users.ELS_cod,'
        ...
        #9#9'(SELECT count(1) FROM actCar'#9'WHERE actCar.act_id = Act.act_id)' +
        ' cnt_actCar,'
      
        #9#9'(SELECT count(1) FROM actEmp'#9'WHERE actEmp.act_id = Act.act_id)' +
        ' cnt_actEmp'
      'FROM'#9'Act'
      
        #9#9'inner join etran_global_id on etran_global_id.global_id = Act.' +
        'act_id '
      
        #9#9'inner join etran_users on etran_global_id.users_owner_id = etr' +
        'an_users.users_id'
      'WHERE'#9'actDate between :date1 and :date2 '
  ...
  object DS_actCar: TDataSource
    DataSet = Query_actCar
    Left = 592
    Top = 576
  end
  object DS_actEmp: TDataSource
    DataSet = Query_actEmp
    Left = 592
    Top = 632
  end
  object Query_actEmp: TADOQuery
    Connection = ADOEtran
    CursorType = ctStatic
    Parameters = <
      item
