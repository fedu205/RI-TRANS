object fmEtrCumulative: TfmEtrCumulative
  Left = 0
  Top = 0
  Caption = #1044#1072#1085#1085#1099#1077' '#1085#1072#1082#1086#1087#1080#1090#1077#1083#1100#1085#1099#1093' '#1074#1077#1076#1086#1084#1086#1089#1090#1077#1081
  ClientHeight = 633
  ClientWidth = 951
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.DataSource = DS_Cumulative
        DataController.Filter.Options = [fcoCaseInsensitive]
        DataController.Filter.OnChanged = cxGrid1DBBandedTableView1DataControllerFilterChanged
        DataController.Filter.Active = True
        DataController.KeyFieldNames = 'cumulative_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            Column = cxGrid1DBBandedTableView1cumulative_id
          end
          item
            Format = '#,##0.00'
            Kind = skSum
          ...
          item
            Format = '#,##0'
            Kind = skSum
            Column = cxGrid1DBBandedTableView1cnt_docs
          end>
  ...
  object Panel2: TPanel
    ...
    object Panel3: TPanel
      ...
      object Label8: TLabel
        ...
        Width = 238
        Height = 13
        Caption = #1057#1090#1072#1085#1094#1080#1080' '#1089#1086#1074#1077#1088#1096#1077#1085#1080#1103' '#1086#1087#1077#1088#1072#1094#1080#1080'....................'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Tahoma'
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGridDBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.Filter.Options = [fcoCaseInsensitive]
        DataController.Filter.Active = True
        DataController.KeyFieldNames = 'cumDue_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            Column = cxGridDBBandedTableView1cumDue_id
          end
          item
            Format = '#,##0.00'
            Kind = skSum
            Column = cxGridDBBandedTableView1dueSum
          end>
        DataController.Summary.SummaryGroups = <>
        DataController.Summary.Options = [soMultipleSelectedRecords]
        OptionsCustomize.ColumnsQuickCustomization = True
  ...
  object Query_Cumulative: TADOQuery
    Connection = ADOEtran
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      ...
      #9#9'etran_users.ELS_cod,'
        ...
        #9#9'(SELECT count(1) FROM cumDue WHERE cumDue.cumulative_id = cumu' +
        'lative.cumulative_id) cnt_docs,'
      
        #9#9'(SELECT sum(dueSum) FROM cumDue WHERE cumDue.cumulative_id = c' +
        'umulative.cumulative_id) dueSum'
      'FROM'#9'cumulative '
      
        #9#9'inner join etran_global_id on etran_global_id.global_id = cumu' +
        'lative.cumulative_id '
      
        #9#9'inner join etran_users on etran_global_id.users_owner_id = etr' +
        'an_users.users_id'
      
        'WHERE'#9'cumDateCreate between :date1 and :date2 AND users_owner_id' +
  ...
  object DS_Cumulative: TDataSource
    DataSet = Query_Cumulative
    Left = 248
    Top = 104
  end
  object Query_cumDue: TADOQuery
    Connection = ADOEtran
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
        ...
        'SELECT'#9'*, (SELECT top 1 inf_obj_name FROM dbo.ETRAN_NSI_INF_OBJ ' +
        'WHERE type_inf_id = 30 and cumDue.dueid = ETRAN_NSI_INF_OBJ.etra' +
        'n_nsi_id) inf_obj_name'
      'FROM'#9'cumDue '
      'WHERE'#9'cumulative_id = :cumulative_id'
      '')
    Left = 624
    Top = 560
  end
  object DS_cumDue: TDataSource
    DataSet = Query_cumDue
    Left = 704
    Top = 560
  end
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\EtrCumulative'
