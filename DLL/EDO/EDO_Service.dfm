object fmEDO_Service: TfmEDO_Service
  Left = 0
  Top = 0
  Caption = #1069#1083#1077#1082#1090#1088#1086#1085#1099#1077' '#1076#1086#1082#1091#1084#1077#1085#1090#1099' '#1087#1086' '#1088#1077#1084#1086#1085#1090#1072#1084' '#1074#1072#1075#1086#1085#1086#1074
  ClientHeight = 588
  ClientWidth = 1087
  Color = clBtnFace
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.Summary.DefaultGroupSummaryItems = <
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = cxGrid1DBBandedTableView1doc_sum_total
        end
        item
          Format = '#,##0.00'
          Kind = skSum
        ...
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = cxGrid1DBBandedTableView1doc_nds
        end
        item
          Format = '#,##0.00'
          Kind = skSum
        ...
        item
          ...
          Kind = skSum
          Position = spFooter
          Column = cxGrid1DBBandedTableView1doc_sum
        end
        item
          Format = '#,##0.00'
          Kind = skSum
      ...
      object cxGrid1DBBandedTableView1EDO_service_id: TcxGridDBBandedColumn
        DataBinding.FieldName = 'EDO_service_id'
        HeaderAlignmentVert = vaTop
        Width = 100
      ...
      object cxGrid1DBBandedTableView1EDO_type: TcxGridDBBandedColumn
        Caption = #1053#1072#1079#1074#1072#1085#1080#1077' '#1092#1086#1088#1084#1099
        DataBinding.FieldName = 'EDO_type'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = 0
        Position.ColIndex = 2
      ...
      object cxGrid1DBBandedTableView1EDO_status: TcxGridDBBandedColumn
        DataBinding.FieldName = 'EDO_status'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = -1
        Position.ColIndex = -1
      ...
      object cxGrid1DBBandedTableView1EDO_id_pak: TcxGridDBBandedColumn
        Caption = #1048#1076#1077#1085#1090#1080#1092#1080#1082#1072#1090#1086#1088' '#1087#1072#1082#1077#1090#1072
        DataBinding.FieldName = 'EDO_id_pak'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = 0
        Position.ColIndex = 3
      ...
      object cxGrid1DBBandedTableView1doc_date: TcxGridDBBandedColumn
      ...
      object cxGrid1DBBandedTableView1doc_sum: TcxGridDBBandedColumn
        Caption = #1057#1091#1084#1084#1072' '#1073#1077#1079' '#1053#1044#1057
        DataBinding.FieldName = 'doc_sum'
      ...
      object cxGrid1DBBandedTableView1doc_nds: TcxGridDBBandedColumn
        Caption = #1053#1044#1057
        DataBinding.FieldName = 'doc_nds'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#,##0.00'
        HeaderAlignmentVert = vaTop
        Styles.Content = cxStyle3
      ...
      object cxGrid1DBBandedTableView1doc_sum_total: TcxGridDBBandedColumn
        Caption = #1057#1091#1084#1084#1072' '#1089' '#1053#1044#1057
        DataBinding.FieldName = 'doc_sum_total'
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = '#,##0.00'
        HeaderAlignmentVert = vaTop
        Styles.Content = cxStyle3
      ...
      object cxGrid1DBBandedTableView1self_OKPO: TcxGridDBBandedColumn
        Caption = #1057#1086#1073#1089#1090#1074#1077#1085#1085#1072#1103' '#1054#1050#1055#1054
        DataBinding.FieldName = 'self_OKPO'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1self_INN: TcxGridDBBandedColumn
        Caption = #1057#1086#1073#1089#1090#1074#1077#1085#1085#1072#1103' '#1048#1053#1053
        DataBinding.FieldName = 'self_INN'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1self_KPP: TcxGridDBBandedColumn
        Caption = #1057#1086#1073#1089#1090#1074#1077#1085#1085#1072#1103' '#1050#1055#1055
        DataBinding.FieldName = 'self_KPP'
        HeaderAlignmentVert = vaTop
        Width = 100
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1depo_cod: TcxGridDBBandedColumn
        Caption = #1044#1077#1087#1086' '#1050#1083#1077#1081#1084#1086
      ...
      object cxGrid1DBBandedTableView1contract_date: TcxGridDBBandedColumn
      ...
      object cxGrid1DBBandedTableView1portal_name: TcxGridDBBandedColumn
        Caption = #1048#1089#1090#1086#1095#1085#1080#1082
        DataBinding.FieldName = 'portal_name'
        HeaderAlignmentVert = vaTop
        Styles.Content = cxStyle1
        Width = 78
        Position.BandIndex = 0
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton101: TdxBarButton
      Tag = 6
      Caption = #1060#1055#1059'-26'
      Category = 0
      Hint = #1060#1055#1059'-26'
      Visible = ivAlways
    ...
    object dxBarSubItem20: TdxBarSubItem
      Caption = #1040#1057#1059' '#1056#1046#1044' (iit.ru)'
      Category = 0
      Visible = ivAlways
      ImageIndex = 23
      ItemLinks = <
    ...
    object dxBarButton104: TdxBarButton
      Tag = 1
      Caption = #1040#1082#1090' '#1087#1088#1080#1077#1084#1072'-'#1087#1077#1088#1077#1076#1072#1095#1080' '#1058#1052#1062
      Category = 0
      Hint = #1040#1082#1090' '#1087#1088#1080#1077#1084#1072'-'#1087#1077#1088#1077#1076#1072#1095#1080' '#1058#1052#1062
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    object dxBarButton105: TdxBarButton
      Tag = 2
      Caption = #1040#1082#1090' '#1073#1088#1072#1082#1086#1074#1082#1080
      Category = 0
      Hint = #1040#1082#1090' '#1073#1088#1072#1082#1086#1074#1082#1080
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    object dxBarButton106: TdxBarButton
      Caption = #1040#1082#1090' '#1079#1072#1084#1077#1085#1099' '#1091#1089#1090#1072#1085#1086#1074#1082#1080' '#1076#1077#1090#1072#1083#1077#1081
      Category = 0
      Hint = #1040#1082#1090' '#1079#1072#1084#1077#1085#1099' '#1091#1089#1090#1072#1085#1086#1074#1082#1080' '#1076#1077#1090#1072#1083#1077#1081
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    object dxBarButton107: TdxBarButton
      Caption = #1050#1072#1088#1090#1086#1095#1082#1072'-'#1076#1086#1082#1091#1084#1077#1085#1090
      Category = 0
      Hint = #1050#1072#1088#1090#1086#1095#1082#1072'-'#1076#1086#1082#1091#1084#1077#1085#1090
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    object dxBarButton108: TdxBarButton
      Caption = #1057#1095#1105#1090'-'#1092#1072#1082#1090#1091#1088#1072
      Category = 0
      Hint = #1057#1095#1105#1090'-'#1092#1072#1082#1090#1091#1088#1072
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    ...
    object dxBarButton110: TdxBarButton
      ...
      Category = 0
      Hint = #1042#1059'-36'#1052
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    object dxBarButton111: TdxBarButton
      Tag = 14
      Caption = #1056#1072#1089#1095#1077#1090' '#1089#1090#1086#1080#1084#1086#1089#1090#1080' '#1091#1089#1083#1091#1075' '#1087#1086' '#1093#1088#1072#1085#1077#1085#1080#1102
      Category = 0
      Hint = #1056#1072#1089#1095#1077#1090' '#1089#1090#1086#1080#1084#1086#1089#1090#1080' '#1091#1089#1083#1091#1075' '#1087#1086' '#1093#1088#1072#1085#1077#1085#1080#1102
      Visible = ivAlways
      OnClick = dxBarButton101Click
    end
    ...
    object dxBarButton113: TdxBarButton
      Caption = #1040#1057#1059' '#1042#1056#1050' (remontvagonov.ru)'
      Category = 0
      Hint = #1040#1057#1059' '#1042#1056#1050' (remontvagonov.ru)'
      Visible = ivAlways
      ImageIndex = 23
    ...
    object dxBarButton114: TdxBarButton
      Tag = 1
      Caption = #1040#1057#1059' '#1042#1040#1056#1045#1050#1057' (warecs.ru)'
      Category = 0
      Hint = #1040#1057#1059' '#1042#1040#1056#1045#1050#1057' (warecs.ru)'
      Visible = ivAlways
      ImageIndex = 23
      OnClick = dxBarButton113Click
    end
    ...
    object dxBarButton116: TdxBarButton
      ...
      Category = 0
      Hint = #1055#1072#1082#1077#1090' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074
      Visible = ivAlways
      ImageIndex = 23
      OnClick = dxBarButton101Click
    end
  ...
  object Query_EDO: TADOQuery
    ...
    SQL.Strings = (
      'SELECT '
      'CASE '
      'WHEN EDO_type = '#39'SYS1'#39' THEN '#39#1040#1057#1059' '#1042#1056#1050#39
      'WHEN EDO_type = '#39'SYS2'#39' THEN '#39#1040#1057#1059' '#1042#1040#1056#1045#1050#1057#39
      'WHEN EDO_type = '#39#1055#1072#1082#1077#1090' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074#39' THEN '#39#1040#1057#1059' '#1056#1046#1044#39
      'END as portal_name,'
      ''
      '* FROM EDO_service'
      'WHERE doc_date BETWEEN :date1 AND :date2')
    Left = 40
    Top = 184
  end
