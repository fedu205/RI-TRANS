object fmECPOtstClaim: TfmECPOtstClaim
  Left = 0
  Top = 0
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.DataSource = DS_ECPOsts
      DataController.Filter.Options = [fcoCaseInsensitive]
      DataController.Filter.OnChanged = cxGrid1DBBandedTableView1FilterOnChanged
      DataController.Filter.Active = True
      DataController.KeyFieldNames = 'etran_ecp_otst_id'
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skCount
          Column = cxGrid1DBBandedTableView1etran_ecp_otst_id
        end
        item
          Format = '#,##0'
          Kind = skSum
          Column = cxGrid1DBBandedTableView1OtstOtpravka_KolWag
        end>
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarSubItem1: TdxBarSubItem
      Caption = #1044#1077#1081#1089#1090#1074#1080#1103' '#1089' '#1079#1072#1103#1074#1082#1086#1081
      Category = 0
      Visible = ivAlways
      ItemLinks = <
        item
    ...
    object dxBarButton12: TdxBarButton
      ...
      Category = 0
      Hint = #1055#1088#1086#1076#1083#1080#1090#1100
      Visible = ivAlways
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\ECPOtstClaim'
  ...
  object Query_ECPOsts: TADOQuery
    ConnectionString = 
      'Provider=SQLOLEDB.1;Password=cjnhfkjubcnbrf;Persist Security Inf' +
      'o=True;User ID=sa;Initial Catalog=lis_etran;Data Source=srv-lis2'
    CursorType = ctStatic
    Parameters = <
      item
        Name = 'date1'
    ...
    SQL.Strings = (
      'SELECT * FROM view_etran_ecp_otst'
      'WHERE date_enter between :date1 and :date2 '
      
        'AND users_owner_id = (SELECT users_id FROM etran_users WHERE use' +
        'rs_name = :users_name)'
      '')
    Left = 264
    Top = 216
  end
  object DS_ECPOsts: TDataSource
    DataSet = Query_ECPOsts
    Left = 232
    Top = 216
  end
