object fmECPNSI: TfmECPNSI
  ...
  object Panel1: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.DataSource = DS_TypeInf
        DataController.Filter.Options = [fcoCaseInsensitive]
        DataController.Filter.OnChanged = cxGrid1DBBandedTableView1FilterOnChanged
        DataController.Filter.Active = True
        DataController.KeyFieldNames = 'nsi_type_inf_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            Column = cxGrid1DBBandedTableView1nsi_type_inf_id
          end>
        ...
        object cxGrid1DBBandedTableView1nsi_type_inf_id: TcxGridDBBandedColumn
          Caption = #8470' '#1079#1072#1087#1080#1089#1080
          DataBinding.FieldName = 'nsi_type_inf_id'
        ...
        object cxGrid1DBBandedTableView1nsi_type_inf_name: TcxGridDBBandedColumn
          Caption = #1058#1072#1073#1083#1080#1094#1072
          DataBinding.FieldName = 'nsi_type_inf_name'
          DataBinding.IsNullValueType = True
          HeaderAlignmentVert = vaTop
          Width = 140
          Position.BandIndex = 0
        ...
        object cxGrid1DBBandedTableView1nsi_type_inf_table: TcxGridDBBandedColumn
          Caption = #1057#1087#1088#1072#1074#1080#1095#1085#1080#1082
          DataBinding.FieldName = 'nsi_type_inf_table'
          DataBinding.IsNullValueType = True
          HeaderAlignmentVert = vaTop
          Width = 128
          Position.BandIndex = 0
        ...
        object cxGrid1DBBandedTableView1nsi_type_date_load: TcxGridDBBandedColumn
          Caption = #1044#1072#1090#1072' '#1079#1072#1075#1088#1091#1079#1082#1080
          DataBinding.FieldName = 'nsi_type_date_load'
          DataBinding.IsNullValueType = True
          HeaderAlignmentVert = vaTop
          Width = 80
          Position.BandIndex = 0
  ...
  object Panel2: TPanel
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGrid2DBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.DataSource = DS_InfObj
        DataController.Filter.Options = [fcoCaseInsensitive]
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            Kind = skCount
            Column = cxGrid2DBBandedTableView1etran_nsi_id
          end>
        DataController.Summary.SummaryGroups = <>
        DataController.Summary.Options = [soMultipleSelectedRecords]
        OptionsCustomize.ColumnsQuickCustomization = True
        ...
        object cxGrid2DBBandedTableView1inf_obj_id: TcxGridDBBandedColumn
          Caption = #8470' '#1079#1072#1087#1080#1089#1080
        ...
        object cxGrid2DBBandedTableView1type_inf_id: TcxGridDBBandedColumn
        ...
        object cxGrid2DBBandedTableView1etran_nsi_id: TcxGridDBBandedColumn
          Caption = #8470' '#1079#1072#1087#1080#1089#1080' '#1053#1057#1048
          DataBinding.FieldName = 'etran_nsi_id'
          DataBinding.IsNullValueType = True
          HeaderAlignmentVert = vaTop
          Width = 80
          Position.BandIndex = 0
        ...
        object cxGrid2DBBandedTableView1inf_obj_cod: TcxGridDBBandedColumn
          Caption = #1050#1086#1076' '#1053#1057#1048
        ...
        object cxGrid2DBBandedTableView1inf_obj_name: TcxGridDBBandedColumn
        ...
        object cxGrid2DBBandedTableView1inf_obj_name_full: TcxGridDBBandedColumn
        ...
        object cxGrid2DBBandedTableView1sucks_own_ways: TcxGridDBBandedColumn
          Caption = #1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' ('#1054#1090#1089#1090#1086#1081' '#1085#1072' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1099#1093' '#1087#1091#1090#1103#1093')'
          DataBinding.FieldName = 'sucks_own_ways'
          DataBinding.IsNullValueType = True
          HeaderAlignmentVert = vaTop
          Width = 150
          Position.BandIndex = -1
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton8: TdxBarButton
      Caption = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1080#1079' '#1069#1058#1056#1040#1053#1072'...'
      Category = 0
      Hint = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1080#1079' '#1069#1058#1056#1040#1053#1072
      Visible = ivAlways
    ...
    object dxBarButton9: TdxBarButton
      Caption = #1048#1079#1084#1077#1085#1080#1090#1100' "'#1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' ('#1054#1090#1089#1090#1086#1081' '#1085#1072' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1099#1093' '#1087#1091#1090#1103#1093')"'
      Category = 0
      Hint = #1048#1079#1084#1077#1085#1080#1090#1100' "'#1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' ('#1054#1090#1089#1090#1086#1081' '#1085#1072' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1099#1093' '#1087#1091#1090#1103#1093')"'
      Visible = ivAlways
      ImageIndex = 1
      OnClick = dxBarButton9Click
    end
    object dxBarButton10: TdxBarButton
      Caption = #1059#1076#1072#1083#1080#1090#1100' "'#1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' ('#1054#1090#1089#1090#1086#1081' '#1085#1072' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1099#1093' '#1087#1091#1090#1103#1093')"'
      Category = 0
      Hint = #1059#1076#1072#1083#1080#1090#1100' "'#1050#1086#1084#1084#1077#1085#1090#1072#1088#1080#1081' ('#1054#1090#1089#1090#1086#1081' '#1085#1072' '#1089#1086#1073#1089#1090#1074#1077#1085#1085#1099#1093' '#1087#1091#1090#1103#1093')"'
      Visible = ivAlways
      ImageIndex = 2
  ...
  object Query_TypeInf: TADOQuery
    Connection = ADOEtran
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM ETRAN_NSI_TYPE_INF')
    Left = 100
    Top = 242
  end
  object DS_TypeInf: TDataSource
    DataSet = Query_TypeInf
    Left = 132
    Top = 242
  end
  ...
  object Query_InfObj: TADOQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'SELECT @object_id = object_id FROM ETRAN_OBJECT_BASE WHERE objec' +
        't_physic_name =  '#39'ETRAN_NSI_INF_OBJ'#39
      
        'SELECT @users_id = users_id FROM etran_users WHERE users_name = ' +
        'system_user'
      ''
      'SELECT '
      #9'inf.[inf_obj_id], '
      ...
      #9'inf.[inf_obj_cod], '
      #9'inf.[inf_obj_name], '
      #9'inf.[inf_obj_name_full], '
      #9#39'sucks_own_ways'#39' = spam.param_value'
      'FROM ETRAN_NSI_INF_OBJ inf'
      'LEFT JOIN ETRAN_GLOBAL_SPAM spam'
      #9'ON @object_id = spam.object_id '
      #9'AND inf.etran_nsi_id = spam.row_id'
      #9'AND @users_id = spam.users_owner_id'
      #9'AND '#39'sucks_own_ways'#39' = spam.param_name'
      'WHERE type_inf_id = :type_inf_id')
    Left = 684
    Top = 258
  end
