object fmECPRepairContract: TfmECPRepairContract
  Left = 0
  Top = 0
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          Kind = skCount
          Column = cxGrid1DBBandedTableView1ContractID
        end>
  ...
  object DS_RepairContract: TDataSource
    DataSet = Query_RepairContract
    Left = 232
    Top = 216
  end
  object Query_RepairContract: TADOQuery
    ConnectionString = 
      'Provider=SQLOLEDB.1;Password=cjnhfkjubcnbrf;Persist Security Inf' +
      'o=True;User ID=sa;Initial Catalog=lis_etran;Data Source=10.10.10' +
      '1.11'
    CursorType = ctStatic
    Parameters = <
      item
    ...
    SQL.Strings = (
      'SELECT * FROM view_repair_contract'
      'WHERE ContractDateBegin between :date1 and :date2 '
