object fmFactMilage: TfmFactMilage
  Left = 0
  Top = 0
  Caption = #1055#1088#1086#1073#1077#1075' '#1074#1072#1075#1086#1085#1072
  ClientHeight = 630
  ClientWidth = 1034
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      object cxGrid1DBBandedTableView1fact_milage_id: TcxGridDBBandedColumn
        Caption = #8470' '#1047#1072#1087#1080#1089#1080
        DataBinding.FieldName = 'fact_milage_id'
      ...
      object cxGrid1DBBandedTableView1milage_norm: TcxGridDBBandedColumn
        Caption = #1053#1086#1088#1084#1072' '#1087#1088#1086#1073#1077#1075#1072
    ...
    object cxTabSheet1: TcxTabSheet
      ...
      object cxGrid2: TcxGrid
        ...
        object cxGrid2DBBandedTableView1: TcxGridDBBandedTableView
          ...
          OnCustomDrawCell = cxGrid1DBBandedTableView1CustomDrawCell
          OnFocusedItemChanged = cxGrid1DBBandedTableView1FocusedItemChanged
          DataController.DataSource = DS_HistoryMilage
          DataController.Filter.Options = [fcoCaseInsensitive]
          DataController.Filter.OnChanged = cxGrid1DBBandedTableView1DataControllerFilterChanged
          DataController.Filter.Active = True
          DataController.KeyFieldNames = 'fact_milage_id'
          ...
          object cxGrid2DBBandedTableView1fact_milage_id: TcxGridDBBandedColumn
            Caption = #8470' '#1047#1072#1087#1080#1089#1080
            DataBinding.FieldName = 'fact_milage_id'
            HeaderAlignmentVert = vaTop
            Width = 69
          ...
          object cxGrid2DBBandedTableView1milage_passed: TcxGridDBBandedColumn
            Caption = #1055#1088#1086#1073#1077#1075' '#1087#1088#1086#1081#1076#1077#1085#1085#1099#1081
            DataBinding.FieldName = 'milage_passed'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DecimalPlaces = 0
          ...
          object cxGrid2DBBandedTableView1milage_rest: TcxGridDBBandedColumn
            Caption = #1055#1088#1086#1073#1077#1075' '#1086#1089#1090#1072#1090#1086#1095#1085#1099#1081
            DataBinding.FieldName = 'milage_rest'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DecimalPlaces = 0
          ...
          object cxGrid2DBBandedTableView1milage_norm: TcxGridDBBandedColumn
            Caption = #1053#1086#1088#1084#1072' '#1087#1088#1086#1073#1077#1075#1072
            DataBinding.FieldName = 'milage_norm'
            PropertiesClassName = 'TcxCurrencyEditProperties'
            Properties.DecimalPlaces = 0
          ...
          object cxGrid2DBBandedTableView1users_id: TcxGridDBBandedColumn
  ...
  object DS_FactMilage: TDataSource
    DataSet = Query_FactMilage
    Left = 96
    Top = 251
  end
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton4: TdxBarButton
      ...
      Category = 0
      Hint = #1044#1072#1085#1085#1099#1077' '#1085#1072' '#1076#1072#1090#1091
      Visible = ivAlways
      ImageIndex = 7
  ...
  object Popup_Milage: TdxBarPopupMenu
    Tag = 1
  ...
  object Query_HistoryMilage: TADOQuery
    CommandTimeout = 100
    Parameters = <
      item
        Name = 'num_vagon'
    ...
    SQL.Strings = (
      'SELECT * FROM fact_milage'
      'WHERE num_vagon = :num_vagon'
      '')
    Left = 99
    Top = 471
  end
  object DS_HistoryMilage: TDataSource
    DataSet = Query_HistoryMilage
    Left = 123
    Top = 485
  end
  object Popup_HistoryMilage: TdxBarPopupMenu
    Tag = 2
    BarManager = dxBarManager1
    ItemLinks = <
      item
  ...
  object Query_FactMilage: TADOQuery
    Parameters = <
      item
        Name = 'date1'
        DataType = ftDateTime
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'SELECT p.fact_milage_id, p.num_vagon, p.milage_passed, p.milage_' +
        'rest, p.milage_norm, p.file_load_name, p.file_load_date, p.users' +
        '_group_id,'
      
        #9'      p.vagon_id, v.rod_vagon_name, v.owner_name, v.type_park_n' +
        'ame, v.contract_cod'
      'FROM fact_milage p WITH (NOLOCK)'
      'INNER JOIN'
      
        '    (SELECT num_vagon, max(file_load_date) as last_load, users_g' +
        'roup_id'
      '    FROM fact_milage WITH (NOLOCK)'
      
        '    WHERE (users_group_id = @users_group_id) AND (file_load_date' +
        ' <= @date1)'
      '    GROUP BY num_vagon, users_group_id) last'
      
        'ON (last.users_group_id = p.users_group_id) AND (last.last_load ' +
        '= p.file_load_date) AND (last.num_vagon = p.num_vagon)'
      ''
      'LEFT JOIN'
      ''
      
        '(SELECT vagon.vagon_id, vagon_model.rod_vagon_name,  view_vagon_' +
        'owner.firm_customer_name as owner_name,'
      
        #9#9#9#9#9'  view_vagon_owner.date_begin, view_vagon_owner.date_end,  ' +
        'view_vagon_owner.type_park_name,  view_vagon_owner.contract_cod'
      'FROM  vagon'
      
        '  INNER JOIN global_id WITH (NOLOCK) ON vagon.vagon_id = global_' +
        'id.global_id'
      '  INNER JOIN users  ON users.users_id = global_id.users_owner'
      
        '  LEFT OUTER JOIN view_vagon_owner ON view_vagon_owner.vagon_id ' +
        '= vagon.vagon_id'
      
        '  LEFT OUTER JOIN vagon_model ON vagon.vagon_model_id = vagon_mo' +
        'del.vagon_model_id'
      'WHERE (users.users_group_id = @users_group_id)'
      ') v'
      
        'ON (p.vagon_id = v.vagon_id) AND FLOOR(convert(float, p.file_loa' +
        'd_date)) BETWEEN FLOOR(convert(float, v.date_begin)) AND FLOOR(c' +
        'onvert(float, ISNULL(v.date_end, getdate() + 1) ))'
      '')
    Left = 78
    Top = 222
  end
