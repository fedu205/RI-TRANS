object fmDocShablon: TfmDocShablon
  Left = 180
  Top = 131
      ...
      object cxGrid1: TcxGrid
        ...
        object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              Kind = skCount
              Column = cxGrid1DBBandedTableView1doc_describe
            end>
  ...
  object Query_Shablon: TADOQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM view_doc_shablon_rights'
      'WHERE 0=1'
      'ORDER BY doc_describe')
    Left = 272
    Top = 191
  end
  ...
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\fmDocShablon'
