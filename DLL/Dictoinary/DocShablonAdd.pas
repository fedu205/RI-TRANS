...
begin
  ...
  if SP_BLOB_modify.Parameters.ParamByName('@doc_id').Value = -9 then
   Application.MessageBox('НЕВОЗМОЖНО ВСТАВИТЬ НОВЫЙ ШАБЛОН', 'ОШИБОЧКА', MB_OK)
