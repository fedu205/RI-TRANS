object fmDistance: TfmDistance
  Left = 0
  Top = 0
  Caption = #1056#1077#1076#1072#1082#1090#1080#1088#1086#1074#1072#1085#1080#1077' / '#1087#1077#1088#1077#1089#1095#1077#1090' '#1088#1072#1089#1089#1090#1086#1103#1085#1080#1081
  ClientHeight = 463
  ClientWidth = 782
  Color = clBtnFace
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = '#,##0'
          Kind = skSum
          Column = cxGrid1DBBandedTableView1days_way
        end>
      ...
      object cxGrid1DBBandedTableView1node1_id: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1086#1090#1087#1088'. (ID)'
        DataBinding.FieldName = 'node1_id'
        DataBinding.IsNullValueType = True
        Visible = False
        HeaderAlignmentVert = vaTop
        Width = 90
      ...
      object cxGrid1DBBandedTableView1node1_cod: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1086#1090#1087#1088'. ('#1050#1086#1076')'
        DataBinding.FieldName = 'node1_cod'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 70
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1node1_name: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1086#1090#1087#1088'. ('#1048#1084#1103')'
        DataBinding.FieldName = 'node1_name'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 130
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1node2_id: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1085#1072#1079#1085'. (ID)'
        DataBinding.FieldName = 'node2_id'
        DataBinding.IsNullValueType = True
        Visible = False
        HeaderAlignmentVert = vaTop
        Width = 90
      ...
      object cxGrid1DBBandedTableView1node2_cod: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1085#1072#1079#1085'. ('#1050#1086#1076')'
        DataBinding.FieldName = 'node2_cod'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 70
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1node2_name: TcxGridDBBandedColumn
        Caption = #1057#1090'. '#1085#1072#1079#1085'. ('#1048#1084#1103')'
        DataBinding.FieldName = 'node2_name'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 107
        Position.BandIndex = 0
      ...
      object cxGrid1DBBandedTableView1days_way: TcxGridDBBandedColumn
        Caption = #1050#1086#1083'-'#1074#1086' '#1076#1085#1077#1081
        DataBinding.FieldName = 'days_way'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
      ...
      object cxGrid1DBBandedTableView1speed: TcxGridDBBandedColumn
        Caption = #1057#1082#1086#1088#1086#1089#1090#1100', '#1082#1084'/'#1089#1091#1090#1082#1080
  ...
  object Query_Distance: TADOQuery
    CursorType = ctStatic
    CommandTimeout = 300
    Parameters = <>
    SQL.Strings = (
      'SELECT TOP 1000 * '
      'FROM view_inf_obj_distance'
      '--WHERE node1_cod IN (node1_cod)'
      'ORDER BY node1_name, node2_name')
    Left = 273
    Top = 97
  end
  object DS_Distance: TDataSource
    DataSet = Query_Distance
    Left = 272
    Top = 128
  end
  object cxPropertiesStore1: TcxPropertiesStore
    ...
    StorageName = '\Software\Lis1\Distance'
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton9: TdxBarButton
      Caption = #1092#1080#1083#1100#1090#1088' '#1087#1086' '#1074#1099#1076#1077#1083#1077#1085#1085#1086#1084#1091
      Category = 0
      Hint = #1092#1080#1083#1100#1090#1088' '#1087#1086' '#1074#1099#1076#1077#1083#1077#1085#1085#1086#1084#1091
      Visible = ivAlways
      ImageIndex = 44
      ShortCut = 123
    ...
    object dxBarButton2: TdxBarButton
      Caption = #1055#1077#1088#1077#1089#1095#1077#1090' '#1088#1072#1089#1089#1090#1086#1103#1085#1080#1081
      Category = 0
      Hint = #1055#1077#1088#1077#1089#1095#1077#1090' '#1088#1072#1089#1089#1090#1086#1103#1085#1080#1081' (Rail-'#1058#1072#1088#1080#1092')'
      Visible = ivAlways
      ImageIndex = 127
      OnClick = dxBarButton2Click
    end
    object dxBarButton10: TdxBarButton
      Caption = #1055#1086' '#1085#1072#1079#1074#1072#1085#1080#1102' "'#1057#1090'.'#1086#1090#1087#1088'."'
      Category = 0
      Hint = #1055#1086' '#1085#1072#1079#1074#1072#1085#1080#1102' "'#1057#1090'.'#1086#1090#1087#1088'."'
      Visible = ivAlways
      ImageIndex = 42
    ...
    object dxBarButton11: TdxBarButton
      Tag = 1
      Caption = #1055#1086' '#1082#1086#1076#1091'"'#1057#1090'.'#1086#1090#1087#1088'."'
      Category = 0
      Hint = #1055#1086' '#1082#1086#1076#1091'"'#1057#1090'.'#1086#1090#1087#1088'."'
      Visible = ivAlways
      ImageIndex = 42
      OnClick = dxBarButton10Click
    end
    object dxBarButton3: TdxBarButton
      Caption = #1059#1076#1072#1083#1080#1090#1100' '#1074#1089#1077' 0 '#1088#1072#1089#1089#1090#1086#1103#1085#1080#1103
      Category = 0
      Hint = #1059#1076#1072#1083#1080#1090#1100' '#1074#1089#1077' 0-'#1074#1099#1077' '#1088#1072#1089#1089#1090#1086#1103#1085#1080#1103
      Visible = ivNever
      ImageIndex = 2
