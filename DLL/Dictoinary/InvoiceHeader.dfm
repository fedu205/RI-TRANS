object fmInvoiceHeader: TfmInvoiceHeader
  Left = 0
  Top = 0
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
      ...
      DataController.DataSource = DS_InvoiceHeader
      DataController.Filter.OnChanged = cxGrid1DBBandedTableView1DataControllerFilterChanged
      DataController.KeyFieldNames = 'invoice_header_id'
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <
        item
          Format = #1050#1086#1083'-'#1074#1086': 0'
          Kind = skCount
          Column = cxGrid1DBBandedTableView1header_description
        end>
      ...
      object cxGrid1DBBandedTableView1invoice_header_id: TcxGridDBBandedColumn
        Caption = #8470' '#1079#1072#1087#1080#1089#1080
        DataBinding.FieldName = 'invoice_header_id'
      ...
      object cxGrid1DBBandedTableView1header_num: TcxGridDBBandedColumn
        DataBinding.FieldName = 'header_num'
        DataBinding.IsNullValueType = True
        HeaderAlignmentVert = vaTop
        Width = 66
        Position.BandIndex = -1
      ...
      object cxGrid1DBBandedTableView1set_only_marked_contract: TcxGridDBBandedColumn
        Caption = #1058#1086#1083#1100#1082#1086' '#1076#1083#1103' '#1089#1087#1077#1094'. '#1076#1086#1075#1086#1074#1086#1088#1086#1074
        DataBinding.FieldName = 'set_only_marked_contract'
        DataBinding.IsNullValueType = True
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxBarButton2: TdxBarButton
      ...
      Category = 0
      Hint = #1044#1077#1081#1089#1090#1074#1091#1102#1097#1080#1077
      Visible = ivAlways
    ...
    object dxBarButton3: TdxBarButton
      Caption = #1056#1077#1082#1074#1080#1079#1080#1090#1099' '#1074' MS Word'
      Category = 0
      Hint = #1056#1077#1082#1074#1080#1079#1080#1090#1099' '#1074' MS Word'
      Visible = ivAlways
      ImageIndex = 9
      OnClick = dxBarButton3Click
    end
    object N1: TdxBarButton
      Caption = #1044#1086#1073#1072#1074#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099'...'
      Category = 1
      Hint = #1044#1086#1073#1072#1074#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099
      Visible = ivAlways
      ImageIndex = 0
      OnClick = N1Click
    end
    object N2: TdxBarButton
      Caption = #1048#1079#1084#1077#1085#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099'...'
      Category = 1
      Hint = #1048#1079#1084#1077#1085#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099
      Visible = ivAlways
      ImageIndex = 1
      OnClick = N2Click
    end
    object N3: TdxBarButton
      Caption = #1059#1076#1072#1083#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099
      Category = 1
      Hint = #1059#1076#1072#1083#1080#1090#1100' '#1088#1077#1082#1074#1080#1079#1080#1090#1099
      Visible = ivAlways
      ImageIndex = 2
      OnClick = N3Click
    end
  ...
  object Popup_InvoiceHeader: TdxBarPopupMenu
  ...
  object Query_InvoiceHeader: TADOQuery
    Connection = ADOInvoiceHeader
    CursorType = ctStatic
    Parameters = <
      item
        Name = 'all_headers'
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM view_invoice_header_rights'
      
        'WHERE (convert(datetime, convert(varchar, getdate(), 112), 112) ' +
        ' BETWEEN date_begin AND ISNULL(date_end, getdate()+1))'
      'OR (0 = :all_headers)'
      'ORDER BY header_num ')
    Left = 88
    Top = 160
  end
  object DS_InvoiceHeader: TDataSource
    DataSet = Query_InvoiceHeader
    Left = 88
    Top = 192
  end
  object ADOInvoiceHeader: TADOConnection
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    OnExecuteComplete = ADOInvoiceHeaderExecuteComplete
    Left = 104
    Top = 104
  end
