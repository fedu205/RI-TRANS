...
cxGrid1DBBandedTableView1set_sanctions_vagon: TcxGridDBBandedColumn;
    ...
    cxGrid12DBBandedTableView1node_begin_cod: TcxGridDBBandedColumn;
    cxGrid12DBBandedTableView1node_end_name: TcxGridDBBandedColumn;
    cxGrid12DBBandedTableView1node_end_cod: TcxGridDBBandedColumn;
    ...
    cxGrid12DBBandedTableView1node_operation_cod: TcxGridDBBandedColumn;
    cxGrid12DBBandedTableView1road_operation_name: TcxGridDBBandedColumn;
    cxGrid12Level1: TcxGridLevel;
    Popup_StayNode: TdxBarPopupMenu;
    Query_History2: TADOQuery;
    cxGrid12DBBandedTableView1set_track_end: TcxGridDBBandedColumn;
