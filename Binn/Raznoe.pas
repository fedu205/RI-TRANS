...
begin
  ...
  if EncodeDate(2026, 9, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 9, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 9, 18) < Q.FieldByName('dt').AsDateTime then begin
