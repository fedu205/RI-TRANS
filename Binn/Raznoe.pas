...
begin
  ...
  if EncodeDate(2026, 4, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 4, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 4, 18) < Q.FieldByName('dt').AsDateTime then begin
