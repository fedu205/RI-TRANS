...
begin
  ...
  if EncodeDate(2026, 2, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 2, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 2, 18) < Q.FieldByName('dt').AsDateTime then begin
