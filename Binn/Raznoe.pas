...
begin
  ...
  if EncodeDate(2026, 11, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 11, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 11, 18) < Q.FieldByName('dt').AsDateTime then begin
