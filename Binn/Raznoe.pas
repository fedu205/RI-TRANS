...
begin
  ...
  if EncodeDate(2025, 09, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 09, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 09, 11) < Q.FieldByName('dt').AsDateTime then begin
