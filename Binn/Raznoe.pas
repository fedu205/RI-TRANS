...
begin
  ...
  if EncodeDate(2025, 10, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 10, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 10, 11) < Q.FieldByName('dt').AsDateTime then begin
