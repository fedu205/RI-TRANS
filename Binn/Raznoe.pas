...
begin
  ...
  if EncodeDate(2025, 05, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 05, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 05, 11) < Q.FieldByName('dt').AsDateTime then begin
