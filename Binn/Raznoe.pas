...
begin
  ...
  if EncodeDate(2026, 7, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 7, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 7, 18) < Q.FieldByName('dt').AsDateTime then begin
