...
begin
  ...
  if EncodeDate(2025, 07, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 07, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 07, 11) < Q.FieldByName('dt').AsDateTime then begin
