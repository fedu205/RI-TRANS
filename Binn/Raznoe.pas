...
begin
  ...
  if EncodeDate(2025, 01, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 01, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 01, 11) < Q.FieldByName('dt').AsDateTime then begin
