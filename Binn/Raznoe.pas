...
begin
  ...
  if EncodeDate(2025, 04, 15) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 04, 13) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2025, 04, 11) < Q.FieldByName('dt').AsDateTime then begin
