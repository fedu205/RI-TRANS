...
begin
  ...
  if EncodeDate(2026, 5, 20) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 5, 19) < Q.FieldByName('dt').AsDateTime then begin
...
begin
  ...
  if EncodeDate(2026, 5, 18) < Q.FieldByName('dt').AsDateTime then begin
