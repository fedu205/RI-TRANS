...
type
  ...
  public
    ...
    function GetECPBinary(doc_id: Integer; var result_xml: string; var message_error: string): Boolean;
...
function TfmECPServerMethodsClient.GetNSIVagon(users_name: string; users_password: string; str_num_vagon: string; var result_xml: string; var message_error: string): Boolean;
begin
  ...
  FGetNSIVagonCommand.Parameters[0].Value.SetWideString(users_name);
  FGetNSIVagonCommand.Parameters[1].Value.SetWideString(users_password);
  FGetNSIVagonCommand.Parameters[2].Value.SetWideString(str_num_vagon);
  FGetNSIVagonCommand.Parameters[3].Value.SetWideString(result_xml);
  FGetNSIVagonCommand.Parameters[4].Value.SetWideString(message_error);
  FGetNSIVagonCommand.ExecuteUpdate;
  result_xml := FGetNSIVagonCommand.Parameters[3].Value.GetWideString;
  message_error := FGetNSIVagonCommand.Parameters[4].Value.GetWideString;
  Result := FGetNSIVagonCommand.Parameters[5].Value.GetBoolean;
end;
...
function TfmECPServerMethodsClient.GetECPBinary(doc_id: Integer; var result_xml: string; var message_error: string): Boolean;
begin
  if FGetECPBinaryCommand = nil then
  begin
    FGetECPBinaryCommand := FDBXConnection.CreateCommand;
    FGetECPBinaryCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FGetECPBinaryCommand.Text := 'TfmECPServerMethods.GetECPBinary';
    FGetECPBinaryCommand.Prepare;
  end;
  FGetECPBinaryCommand.Parameters[0].Value.SetInt32(doc_id);
  FGetECPBinaryCommand.Parameters[1].Value.SetWideString(result_xml);
  FGetECPBinaryCommand.Parameters[2].Value.SetWideString(message_error);
  FGetECPBinaryCommand.ExecuteUpdate;
  result_xml := FGetECPBinaryCommand.Parameters[1].Value.GetWideString;
  message_error := FGetECPBinaryCommand.Parameters[2].Value.GetWideString;
  Result := FGetECPBinaryCommand.Parameters[3].Value.GetBoolean;
end;

function TfmECPServerMethodsClient.GetECPSign(doc_id: Integer; doc_text: string; var result_xml: string; var message_error: string): Boolean;
begin
  ...
  FGetECPSignCommand.Parameters[0].Value.SetInt32(doc_id);
  FGetECPSignCommand.Parameters[1].Value.SetWideString(doc_text);
  FGetECPSignCommand.Parameters[2].Value.SetWideString(result_xml);
  FGetECPSignCommand.Parameters[3].Value.SetWideString(message_error);
  FGetECPSignCommand.ExecuteUpdate;
  result_xml := FGetECPSignCommand.Parameters[2].Value.GetWideString;
  message_error := FGetECPSignCommand.Parameters[3].Value.GetWideString;
  Result := FGetECPSignCommand.Parameters[4].Value.GetBoolean;
end;

function TfmECPServerMethodsClient.GetECPTSP(doc_id: Integer; doc_text: string; var result_xml: string; var message_error: string): Boolean;
begin
  ...
  FGetECPTSPCommand.Parameters[0].Value.SetInt32(doc_id);
  FGetECPTSPCommand.Parameters[1].Value.SetWideString(doc_text);
  FGetECPTSPCommand.Parameters[2].Value.SetWideString(result_xml);
  FGetECPTSPCommand.Parameters[3].Value.SetWideString(message_error);
  FGetECPTSPCommand.ExecuteUpdate;
  result_xml := FGetECPTSPCommand.Parameters[2].Value.GetWideString;
  message_error := FGetECPTSPCommand.Parameters[3].Value.GetWideString;
  Result := FGetECPTSPCommand.Parameters[4].Value.GetBoolean;
end;
...
function TfmECPServerMethodsClient.SendECPBinary(doc_id: Integer; doc_text: string; doc_sign: string; doc_tsp: string; var result_xml: string; var message_error: string): Boolean;
begin
  if FSendECPBinaryCommand = nil then
  begin
    FSendECPBinaryCommand := FDBXConnection.CreateCommand;
    FSendECPBinaryCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FSendECPBinaryCommand.Text := 'TfmECPServerMethods.SendECPBinary';
    FSendECPBinaryCommand.Prepare;
  end;
  FSendECPBinaryCommand.Parameters[0].Value.SetInt32(doc_id);
  FSendECPBinaryCommand.Parameters[1].Value.SetWideString(doc_text);
  FSendECPBinaryCommand.Parameters[2].Value.SetWideString(doc_sign);
  FSendECPBinaryCommand.Parameters[3].Value.SetWideString(doc_tsp);
  FSendECPBinaryCommand.Parameters[4].Value.SetWideString(result_xml);
  FSendECPBinaryCommand.Parameters[5].Value.SetWideString(message_error);
  FSendECPBinaryCommand.ExecuteUpdate;
  result_xml := FSendECPBinaryCommand.Parameters[4].Value.GetWideString;
  message_error := FSendECPBinaryCommand.Parameters[5].Value.GetWideString;
  Result := FSendECPBinaryCommand.Parameters[6].Value.GetBoolean;
end;
...
function TfmECPServerMethodsClient.CancelDocs(doc_id: Integer; var result_xml: string; var message_error: string): Boolean;
begin
  if FCancelDocsCommand = nil then
  begin
    FCancelDocsCommand := FDBXConnection.CreateCommand;
    FCancelDocsCommand.CommandType := TDBXCommandTypes.DSServerMethod;
    FCancelDocsCommand.Text := 'TfmECPServerMethods.CancelDocs';
    FCancelDocsCommand.Prepare;
  end;
  FCancelDocsCommand.Parameters[0].Value.SetInt32(doc_id);
  FCancelDocsCommand.Parameters[1].Value.SetWideString(result_xml);
  FCancelDocsCommand.Parameters[2].Value.SetWideString(message_error);
  FCancelDocsCommand.ExecuteUpdate;
  result_xml := FCancelDocsCommand.Parameters[1].Value.GetWideString;
  message_error := FCancelDocsCommand.Parameters[2].Value.GetWideString;
  Result := FCancelDocsCommand.Parameters[3].Value.GetBoolean;
end;
